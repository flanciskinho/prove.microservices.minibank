package org.example.minibank.accountoperation.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "accountoperation@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "accountoperation API";

        private String description = "accountoperation API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "accountoperation";
